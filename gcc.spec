...
unset CFLAGS
unset CXXFLAGS
export CFLAGS="-march=westmere -g1 -O3 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro  -Wl,-z,max-page-size=0x1000 -mtune=sapphirerapids  -fPIC -falign-functions=32  -gz=zstd"
export CXXFLAGS="-march=westmere -g1 -O3  -Wl,-z,max-page-size=0x1000 -mtune=sapphirerapids  -fPIC  -gz=zstd"
...
unset CFLAGS
unset CXXFLAGS
export CFLAGS="-march=ivybridge -g -O3 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro  -Wl,-z,max-page-size=0x1000  -gz=zstd"
export CXXFLAGS="-march=ivybridge -g -O3  -Wl,-z,max-page-size=0x1000  -gz=zstd"
