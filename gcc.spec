...
unset CFLAGS
unset CXXFLAGS
export CFLAGS="-march=westmere -g1 -O3 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro  -Wl,-z,max-page-size=0x1000 -mtune=sapphirerapids  -fPIC -falign-functions=32  -gz=zstd -femit-struct-debug-baseonly -gno-column-info -gno-variable-location-views"
export CXXFLAGS="-march=westmere -g1 -O3  -Wl,-z,max-page-size=0x1000 -mtune=sapphirerapids  -fPIC  -gz=zstd  -femit-struct-debug-baseonly -gno-column-info -gno-variable-location-view"
...
unset CFLAGS
unset CXXFLAGS
export CFLAGS="-march=ivybridge -g -O3 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro  -Wl,-z,max-page-size=0x1000  -gz=zstd  -femit-struct-debug-baseonly -gno-column-info -gno-variable-location-view"
export CXXFLAGS="-march=ivybridge -g -O3  -Wl,-z,max-page-size=0x1000  -gz=zstd  -femit-struct-debug-baseonly -gno-column-info -gno-variable-location-view"
